...
data_path = "./main_files/SPI_data/1667"
...
target_scw_ids = ('166700730010', '166700750010')
target_scw_indices = []
...
ebounds, binned_counts = log_binning_function_for_x_number_of_bins(125)(ebounds, data_total, (20., 81.5))
...
plt.savefig("./main_files/ppc_test/1667_73_75_test.pdf")
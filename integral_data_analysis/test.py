...
from RebinningFunctions import spimodfit_binning_SE, exp_binning_function_for_x_number_of_bins, no_rebinning #, rebin_data_exp_50
from PointingClusters import PointingClusters, save_clusters, load_clusters
from ModelSources import *
import pickle

data_folder = "./integral_data_analysis/simulated_data/0374_const_const_bkg_20_lin_source"
...
pointings = ((('037400020010', './integral_data_analysis/simulated_data/0374_const_const_bkg_20_lin_source'),
  ('037400030010', './integral_data_analysis/simulated_data/0374_const_const_bkg_20_lin_source')),)

source_model = define_sources((
    (simulated_linear_0374, ()),
))

d_path = "./integral_data_analysis/simulated_data/0374_const_const_bkg_20_lin_source_single_pair"
...
#         energy_ranges[i],
#         np.geomspace(18, 3000, 50),
#         exp_binning_function_for_x_number_of_bins(25),
#         # true_values=true_values(),
#         folder=temp_path,
#         source_spectrum_powerlaw_binning=False
#     )
